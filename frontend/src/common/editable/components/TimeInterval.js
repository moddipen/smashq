  ...
  render () {
    ...
    return (
      <FormGroup>
        ...
        <Input placeholder={this.props.placeholder} value={this.getDurationValue()}
               ...
               bsSize={this.props.bsInputSize} name="amount"/>
        <Label>Interval</Label>
        <Input placeholder={this.props.placeholder} value={this.getIntervalValue()}
               onChange={this.setValue.bind(this)} onBlur={this.onBlur.bind(this)}
               onKeyDown={this.handleKeyDown.bind(this)} autoFocus={true} className={isInvalid}
               bsSize={this.props.bsInputSize} type="select" name="type">
